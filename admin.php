				...
				<article>
					...
					<div class="inner">
						<header>
                            ...
                            <h6>100년의 피자 카페 인 시애틀은 재료 하나하나 본사에서 선정한 엄선된 재료로 <br>
                            세상에서 가장 맛있는 웰빙피자라는 타이틀로 대한민국 최고의 프리미엄 웰빙 피자를 선보이고 있습니다.</h6>
                        </header>
                        <a href="#" class="template-btn mt-3" style="font-weight: bolder; color : black;">메뉴 보기</a>
                    </div>
				</article>
				<article>
					...
					<div class="inner">
                        ...
                        <a href="#" class="template-btn mt-3" style="font-weight: bolder; color : black;">자세히 보기</a>
                    </div>
                </article>
                <article>
                ...
                <article>
					...
					<div class="inner">
						<header>
                            <h1>CAFE in SEATTLE</h1>
                            <h6>100년의 피자 카페 인 시애틀은 재료 하나하나 본사에서 선정한 엄선된 재료로 <br>
                            세상에서 가장 맛있는 웰빙피자라는 타이틀로 대한민국 최고의 프리미엄 웰빙 피자를 선보이고 있습니다.</h6><br>
                        </header>
                        <a href="#" class="template-btn mt-3" style="font-weight: bolder; color : black;">자세히 보기</a>
                    </div>
				</article>
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="welcome-text mt-5 mt-md-0">
                        <h2><span class="style-change">OUR</span> <span style="color: #131230;">STORY</span></h2>
                        <p class="pt-3">피자투어 카페는 주문 즉시 즉석에서 만드는 생치자 시스템으로 따끈따끈한 프리미엄 웰빙피자를 드실 수 있습니다. 피자투어 카페의 닭강정 등 사이드 메뉴는 피자투어만의 레시피로 만들어지는 독특한 맛으로 이미 20년간 소비자들의 사랑과 선택으로 만들어지고 있습니다.</p>
                        <a href="#" class="template-btn mt-3" style="font-weight: bolder;">자세히</a>
                    </div>
                </div>
            </div><br><br>
        </div>
                        ...
                        <div class="testimonial-slider owl-carousel">
                            <div class="single-slide d-md-inline-flex">
                                <div class="single-food">
                                    <div class="food-img">
                                        <a href="#"><img src="assets/images/bg_1.png" class="img-fluid" alt="" ></a><br>
                                    </div>
                                    <div class="food-content">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="prime-color"style="font-weight: bolder;">고구마 피자1</h5>
                                            <span class="style-change" style="font-weight: bolder;">$14.50</span>
                                        </div>
                                        <p class="pt-3" style="color: white;">달콤하고 건강한 고구마 피자.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="single-slide d-md-inline-flex">
                                <div class="single-food">
                                    <div class="food-img">
                                        <img src="assets/images/bg_1.png" class="img-fluid" alt=""><br>
                                    </div>
                                    <div class="food-content">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="prime-color"style="font-weight: bolder;">고구마 피자2</h5>
                                            <span class="style-change" style="font-weight: bolder;">$14.50</span>
                                        </div>
                                        <p class="pt-3" style="color: white;">달콤하고 건강한 고구마 피자.</p>
                                    </div>
                            ...
                            <div class="single-slide d-md-inline-flex">
                                <div class="single-food">
                                    ...
                                    <div class="food-content">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="prime-color"style="font-weight: bolder;">고구마 피자3</h5>
                                            <span class="style-change" style="font-weight: bolder;">$14.50</span>
                                        </div>
                                        <p class="pt-3" style="color: white;">달콤하고 건강한 고구마 피자.</p>
                                    </div>
                            ...
                            <div class="single-slide d-md-inline-flex">
                                <div class="single-food">
                                    ...
                                    <div class="food-content">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="prime-color"style="font-weight: bolder;">고구마 피자4</h5>
                                            <span class="style-change" style="font-weight: bolder;">$14.50</span>
                                        </div>
                                        <p class="pt-3" style="color: white;">달콤하고 건강한 고구마 피자.</p>
                                    </div>
                            ...
                            <div class="single-slide d-md-inline-flex">
                                <div class="single-food">
                                    ...
                                    <div class="food-content">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="prime-color"style="font-weight: bolder;">고구마 피자5</h5>
                                            <span class="style-change" style="font-weight: bolder;">$14.50</span>
                                        </div>
                                        <p class="pt-3" style="color: white;">달콤하고 건강한 고구마 피자.</p>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top2 center">
                        <h2><span class="style-change">SET MENU</span></h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="" class="template-btn template-btn2 mt-4" style="font-weight: bolder;">재료이야기</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="update-area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-top2 text-center">
                        <h2><span class="style-change">SERVICES</span></h2>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-food">
                        ...
                        <div class="food-content">
                            <h5 style="font-weight: bolder;">신선한 재료</h5>
                ...
                <div class="col-md-4">
                    <div class="single-food my-5 my-md-0">
                        ...
                        <div class="food-content">
                            <h5 style="font-weight: bolder;">신속한 배달</h5>
                            <p>오리지널 이태리풍 피자소스 사용 하여
                                경쟁 브랜드와 차별화를 꾀하여 독보적인 기술력을 선보이고 있습니다.</p>
                            <a href="#" class="template-btn3 mt-2">read more <span><i class="fa fa-long-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="single-food">
                        ...
                        <div class="food-content">
                            <h5 style="font-weight: bolder;">100년 전통</h5>
